...
urlpatterns = patterns('',
    ...
    url(r'^update_birdpile/?$', 'birding_ear.views.update_birdpile'),
    url(r'^update_bird_detail/?$', 'birding_ear.views.update_bird_detail'),
    url(r'^update_settings/?$', 'birding_ear.views.update_settings'),
